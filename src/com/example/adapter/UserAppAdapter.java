 ...
 * 2016-6-14
 */
public class UserAppAdapter extends MyBaseAdapter<RuningAppInfo> {

	public UserAppAdapter(Context context, List<RuningAppInfo> datas) {
		super(context, datas);
	}
	...
	protected View initItemView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView == null){
			...
			view = View.inflate(context, R.layout.listview_userapp_item, null);
			holder = new ViewHolder();
			holder.mIv_icon = (ImageView) view.findViewById(R.id.iv_listview_userapp_icon);
			holder.mTv_name = (TextView) view.findViewById(R.id.tv_listview_userapp_name);
			holder.mTv_desc = (TextView) view.findViewById(R.id.tv_listview_userapp_desc);
			holder.mTv_dir = (TextView) view.findViewById(R.id.tv_listview_userapp_dir);
			view.setTag(holder);
